...
const Footer = () => {
  ...
  return (
    <footer className="border-t-4 border-zinc-800 bg-[#0a0a0a] pt-12 pb-8 md:pt-20 md:pb-12 font-chakra relative">
      <div className="max-w-7xl mx-auto px-6 text-zinc-100 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12">
          ...
          <div className="text-center md:text-left flex-1 w-full">
            ...
            {/* Hackathon Tech Stack Tag - Wrapped in a flex container for safe mobile centering */}
            <div className="mt-6 flex justify-center md:justify-start">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-zinc-900 border-2 border-zinc-800 border-b-4">
          ...
          {/* Links Grid - Fixed mobile layout */}
          {/* Swapped gap-16 for gap-10 and allowed wrapping if screen is super small */}
          <div className="flex flex-row flex-wrap justify-center sm:justify-start gap-10 md:gap-24 w-full md:w-auto">
            {/* Link Column 1 */}
            {/* Added mobile centering to match the logo text */}
            <div className="flex flex-col items-center md:items-start gap-4 text-center md:text-left">
              <span className="text-zinc-500 font-black tracking-widest text-xs uppercase mb-1">
                Hackathon
              </span>
              <button
        ...
        {/* Scaled down margin on mobile */}
        <div className="w-full h-1 bg-zinc-900 rounded-full my-8 md:my-12"></div>

        {/* Bottom Bar - Centered text on mobile */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-black text-zinc-600 uppercase tracking-widest text-center">
